...
* ![](.my_project01_images/商品分类导航.png)
* 搜索栏

`查看用户列表、状态，支持冻结/启用。`
* ![](.my_project01_images/商品分类导航.png)
* 商品详情(加入购物车、立即抢购)
* ![](.my_project01_images/商品详情.png)
* 瀑布流布局
* 高性能排行榜单
* ![](.my_project01_images/高性能排行榜单.png)
* 用户下单(确认和生成订单)
* ![](.my_project01_images/用户下单.png)
* ![](.my_project01_images/成功下单.png)
...
* 订单管理
* ![](.my_project01_images/订单管理.png)
* 商品管理

`支持新增、编辑、删除商品，上传图片，设置库存、分类等。`
* ![](.my_project01_images/商品管理.png)
* 商品分类管理

`查看商品分类明细和支持新增、编辑、删除等操作`
* ![](.my_project01_images/分类管理.png)
* 用户管理
